...
private class SidebarView: NSStackView {
    ...
    override init(frame: NSRect) {
        ...
        let pauseButton = self.makeButton(title: localizedString("Pause the XStatus"), image: self.pauseState ? self.resumeIcon : self.pauseIcon, action: #selector(togglePause))
    ...
    @objc private func togglePause() {
        ...
        self.pauseButton?.toolTip = localizedString(self.pauseState ? "Resume the XStatus" : "Pause the XStatus")
